...
hunits = [1, 2, 4, 8, 16]
opt_comb = {"gated":{8:{1:0.01, 2:0.01, 4:0.01, 8:0.01, 16:0.01}, 12:{1:0.01, 2:0.01, 4:0.01, 8:0.01, 16:0.01}, 16:{1:0.01, 2:0.01, 4:0.005, 8:0.01, 16:0.01}},\
            "accumulating":{8:{1:0.01, 2:0.01, 4:0.01, 8:0.01, 16:0.01}, 12:{1:0.005, 2:0.005, 4:0.005, 8:0.005, 16:0.005}, 16:{1:0.001, 2:0.001, 4:0.001, 8:0.001, 16:0.001}},\
            "etd_int_0.01":{8:{1:0.05, 2:0.05, 4:0.01, 8:0.01, 16:0.01}, 12:{1:0.01, 2:0.01, 4:0.01, 8:0.01, 16:0.01}, 16:{1:0.01, 2:0.01, 4:0.01, 8:0.01, 16:0.01}},\
            "etd_adaptive_int_0.5":{8:{1:0.001, 2:0.0005, 4:0.001, 8:0.001, 16:0.001}, 12:{1:0.0005, 2:0.0005, 4:0.0005, 8:0.0005, 16:0.0005}, 16:{1:0.0005, 2:0.0005, 4:0.0001, 8:0.0005, 16:0.0005}}}
...
pdf = matplotlib.backends.backend_pdf.PdfPages("plots/End2End_traces_Grid2_hidden_units_test.pdf")
...
plt.legend([name[t] for t, _ in opt_comb.items()]+["PTD (forward)"], frameon=False, fontsize=16)
fig.tight_layout()
